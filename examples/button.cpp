...
{
    std::cout << "Button were clicked" << std::endl;
}
...
int main()
{
    ...
    Button myButton;    // declarate button
    ...
    while (window.isOpen())
    {
        ...
        myButton.update(window.mapPixelToCoords(sf::Mouse::getPosition(window)));     // update button mouse check algorithm by current mouse position
